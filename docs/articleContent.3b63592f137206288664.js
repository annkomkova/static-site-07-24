...
var token = 'patGPeZ8jw89QLPLb.1bde4f392fc00654a04394c522fac67bc9896a974935bd09a0c3eb38b83be512';
airtable__WEBPACK_IMPORTED_MODULE_0___default().configure({
  endpointUrl: 'https://api.airtable.com',
  apiKey: token
});
var base = airtable__WEBPACK_IMPORTED_MODULE_0___default().base('appvK9hZjGiZ9kW4A');
...
function createArticleContent(stroke) {
  ...
  var contentItem = document.querySelector('.S_ArticleContent');
...
document.addEventListener('DOMContentLoaded', function () {
  getArticleContent().then(function (data) {
    content = data;
    initArticleContent();
  });
});
