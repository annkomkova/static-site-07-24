...
;// CONCATENATED MODULE: ./src/javascripts/search-data.js

var token = 'patDfDG5wTN6XCIvH.beebf3cf0ed7a537e2f3ece84e15f386dc6cf12e9bb2e9319e4eca068099394f';
airtable_umd_default().configure({
  endpointUrl: 'https://api.airtable.com',
  apiKey: token
});
var base = airtable_umd_default().base('appePrphSXY2TX8TD');
...
;// CONCATENATED MODULE: ./src/components/A_Text.jsx


var A_Text = function A_Text(_ref) {
  var text = _ref.text,
    type = _ref.type;
  var classes = classnames_default()('A_Text', type);
  return /*#__PURE__*/react.createElement("div", {
    className: classes
  }, text);
};
/* harmony default export */ const components_A_Text = (A_Text);
;// CONCATENATED MODULE: ./src/components/M_PostTeaser.jsx


// import A_Image from './A_Image.jsx'

var M_PostTeaser = function M_PostTeaser(_ref) {
  ...
  return /*#__PURE__*/react.createElement("a", {
    ...
    return /*#__PURE__*/react.createElement(components_A_Text, {
      type: "tag",
      text: tag,
      key: i
    });
...
/* harmony default export */ const components_M_PostTeaser = (M_PostTeaser);
;// CONCATENATED MODULE: ./src/components/A_Input.jsx

var A_Input = function A_Input(_ref) {
...
/* harmony default export */ const components_A_Input = (A_Input);
;// CONCATENATED MODULE: ./src/components/A_Button.jsx


var A_Button = function A_Button(_ref) {
  var text = _ref.text,
    handleClick = _ref.handleClick,
    disabled = _ref.disabled,
    type = _ref.type;
  var classes = classnames_default()('A_Button', type, {
    disabled: disabled
  });
  return /*#__PURE__*/react.createElement("div", {
    className: classes,
...
/* harmony default export */ const components_A_Button = (A_Button);
;// CONCATENATED MODULE: ./src/components/M_SearchForm.jsx



var M_SearchForm = function M_SearchForm(_ref) {
...
;// CONCATENATED MODULE: ./src/components/M_PostSuggestion.jsx
...
;// CONCATENATED MODULE: ./src/components/O_SearchBar.jsx
...
var O_SearchBar = function O_SearchBar(_ref) {
  ...
  }, /*#__PURE__*/react.createElement(components_M_SearchForm, {
...
/* harmony default export */ const components_O_SearchBar = (O_SearchBar);
;// CONCATENATED MODULE: ./src/components/S_SearchContent.jsx
...
var S_SearchContent = function S_SearchContent(_ref) {
  var initialInput = _ref.searchInputValue;
  var _useState = (0,react.useState)([]),
    _useState2 = _slicedToArray(_useState, 2),
    postTeasers = _useState2[0],
    setPostTeasers = _useState2[1];
  ...
  var _useState5 = (0,react.useState)(true),
    ...
    isSearchButtonDisabled = _useState6[0],
    setIsSearchButtonDisabled = _useState6[1];
  ...
  var handleSearchInput = function handleSearchInput(value) {
    return setSearchInputValue(value);
  };
  var handleSearchSubmit = function handleSearchSubmit() {};
  var renderPostTeasers = function renderPostTeasers() {
    var clean = function clean(str) {
      return str.replace(/[\u202F\u00A0]/g, ' ').replace(/[.,\/#!$%\^&\*;:{}=\-_`~()]/g, '').toLowerCase();
    };
    var value = searchInputValue.toLowerCase();
    return postTeasers.filter(function (t) {
      return clean(t.title).includes(value) || clean(t.description).includes(value);
    }).map(function (t) {
      return /*#__PURE__*/react.createElement(components_M_PostTeaser, {
        key: t.id,
        title: t.title,
        description: t.description,
        url: t.url,
  ...
  return /*#__PURE__*/react.createElement("div", {
  ...
  }, /*#__PURE__*/react.createElement(components_O_SearchBar, {
    searchInputValue: searchInputValue,
    isSearchButtonDisabled: isSearchButtonDisabled,
    handleSearchInput: handleSearchInput,
    handleSearchSubmit: handleSearchSubmit,
    ...
    className: "C_PostTeasers"
  }, renderPostTeasers()));
};
/* harmony default export */ const components_S_SearchContent = (S_SearchContent);
;// CONCATENATED MODULE: ./src/javascripts/search.jsx
...
var app = document.querySelector('.W_ReactModule');
var root = (0,client.createRoot)(app);
root.render(/*#__PURE__*/react.createElement(components_S_SearchContent, {
