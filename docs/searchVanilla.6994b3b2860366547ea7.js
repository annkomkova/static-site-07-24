...
;// CONCATENATED MODULE: ./src/javascripts/search-vanilla.js
...
function createCards(contentDataItem) {
  var title = contentDataItem.title,
    ...
    tags = contentDataItem.tags,
    className = contentDataItem.className;
  var contentItem = document.createElement('a');
  contentItem.classList.add('O_ContentItem');
  contentItem.classList.add("".concat(className));
